...
function Model({ ...props }) {
  ...
  const { nodes, materials } = useGLTF(
    dev
      ? "http://localhost:3000/models/forest-road.glb"
      : "https://experiments.kevinmerinsky.com/models/forest-road.glb"
  );
  return (
    ...
    <>
      <Header info="" recycle>
        ...
        <Image
          ...
          objectFit="cover"
        />
        <caption>Rendered image from Blender using cycles engine</caption>
      </Header>
      <div className="webgl">
        <Canvas
