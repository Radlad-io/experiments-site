  ...
  return (
    <>
      <Header
        ...
        info={
          <p>
            Animating a custom model. The intention of this project is to
            explore the very new WebXR API, which will one day power augmented
            reality experiences delivered via web browsers. At this time, these
      ...
      >
        <CodeLink link="https://github.com/Radlad-io/experiments-webxr/blob/main/5-model_animated.html" />
      </Header>
      <iframe
        className={styles.frame}
        src="https://webxr.kevinmerinsky.com/5-model_animated.html"
      ></iframe>
      <div className={styles.launch}>
        <a href="https://webxr.kevinmerinsky.com/5-model_animated.html">
